...
const Features = () => {
  return (
    <div className='pd_hero pd_features'>
      <h4>FEATURES</h4>
                ...
                <div className="text_box">
                    <div className="inner_flex">
                      ...
                      <div className="inner_text">
                        ...
                        <p>Search out over 200+ thousand recipes over the world using keywords</p>
                      </div>
                      <span></span>
                    </div>
                </div>
                <div className="text_box">
                    <div className="inner_flex">
                      ...
                      <div className="inner_text">
                        ...
                        <p>Search out over 400+ thousand recipes over the world using keywords</p>
                      </div>
                      <span></span>
                    </div>
                </div>
